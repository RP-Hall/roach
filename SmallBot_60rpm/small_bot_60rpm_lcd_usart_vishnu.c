	...
	while(1)
 	 {
		switch (usart_data)
		{
			case 'a': USART1_Transmit_8Bit('a');flash_on();break;
			case 'b': USART1_Transmit_8Bit('b');flash_off();break;
			case 'c': USART1_Transmit_8Bit('c');ground_left();break;
			case 'd': USART1_Transmit_8Bit('d');ground_right();break;
			case 'e': USART1_Transmit_8Bit('e');ground_front();break;
			case 'f': USART1_Transmit_8Bit('f');ground_reset();break;
			case 'g': USART1_Transmit_8Bit('g');stairs_left();break;
			case 'h': USART1_Transmit_8Bit('h');stairs_right();break;
			case 'i': USART1_Transmit_8Bit('i');stairs_front();break;
			case 'j': USART1_Transmit_8Bit('j');stairs_reset();break;
			case 'k': USART1_Transmit_8Bit('k');initialize();break;
			default: break;
		}
	 }
	return 0;
